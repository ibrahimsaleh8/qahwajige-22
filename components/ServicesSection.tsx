    ...
    <section id="services" className="relative bg-second-background py-20">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-14">
          <p className="inline-block bg-main-color-dark text-white text-xs font-bold uppercase tracking-[0.25em] px-5 py-2 rounded-full mb-5 border border-main-color/10 shadow-sm">
              {label}
          </p>
        ...
        {items &&
          items.map((card) => {
            ...
            return (
              <div
                key={card.title}
                className="flex flex-col text-center items-center bg-card-background border border-main-color/10 rounded-2xl p-7 shadow-[0_14px_36px_rgba(82,97,185,0.12)] hover:-translate-y-1 transition-all duration-300">
